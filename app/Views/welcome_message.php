...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="<?= base_url('assets') ?>/template_files/images/favicon.ico" type="image/x-icon" />

        <link href="<?= base_url('assets') ?>/template_files/css" rel="stylesheet" />
        <link href="<?= base_url('assets') ?>/template_files/css(1)" rel="stylesheet" />

        <link rel="stylesheet" type="text/css" href="<?= base_url('assets') ?>/template_files/bootstrap.min.css" />

        <link rel="stylesheet" href="<?= base_url('assets') ?>/template_files/waves.min.css" type="text/css" media="all" />

        <link rel="stylesheet" type="text/css" href="<?= base_url('assets') ?>/template_files/feather.css" />

        <link rel="stylesheet" type="text/css" href="<?= base_url('assets') ?>/template_files/font-awesome-n.min.css" />

        <link rel="stylesheet" href="<?= base_url('assets') ?>/template_files/chartist.css" type="text/css" media="all" />

        <link rel="stylesheet" type="text/css" href="<?= base_url('assets') ?>/template_files/style.css" />
        <link rel="stylesheet" type="text/css" href="<?= base_url('assets') ?>/template_files/widget.css" />
    ...
    <body themebg-pattern="theme1" data-new-gr-c-s-check-loaded="14.1156.0" data-gr-ext-installed="">
                ...
                <nav class="navbar header-navbar pcoded-header iscollapsed" header-theme="themelight1" pcoded-header-position="fixed">
                    <div class="navbar-wrapper">
                        <div class="navbar-logo" logo-theme="theme6">
                            <a href="#">
                                <img class="img-fluid" src="<?= base_url('assets') ?>/template_files/logo.png" alt="Theme-Logo" />
                            </a>
                        ...
                        <div class="navbar-container container-fluid">
                            ...
                            <ul class="nav-right">
                                <li class="header-notification">
                                    <div class="dropdown-primary dropdown">
                                        ...
                                        <ul class="show-notification notification-view dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                            ...
                                            <li>
                                                <div class="media">
                                                    <img class="img-radius" src="<?= base_url('assets') ?>/template_files/avatar-4.jpg" alt="Generic placeholder image" />
                                            ...
                                            <li>
                                                <div class="media">
                                                    <img class="img-radius" src="<?= base_url('assets') ?>/template_files/avatar-3.jpg" alt="Generic placeholder image" />
                                                    <div class="media-body">
                                ...
                                <li class="user-profile header-notification">
                                    <div class="dropdown-primary dropdown">
                                        <div class="dropdown-toggle" data-toggle="dropdown">
                                            <img src="<?= base_url('assets') ?>/template_files/avatar-4.jpg" class="img-radius" alt="User-Profile-Image" />
                                            <span>John Doe</span>
                                    ...
                                    <div class="main-friend-list" style="overflow: hidden; width: auto; height: 519px;">
                                        <div class="media userlist-box waves-effect waves-light" data-id="1" data-status="online" data-username="Josephin Doe">
                                            <a class="media-left" href="#!">
                                                <img class="media-object img-radius img-radius" src="<?= base_url('assets') ?>/template_files/avatar-3.jpg" alt="Generic placeholder image " />
                                        ...
                                        <div class="media userlist-box waves-effect waves-light" data-id="2" data-status="online" data-username="Lary Doe">
                                            <a class="media-left" href="#!">
                                                <img class="media-object img-radius" src="<?= base_url('assets') ?>/template_files/avatar-2.jpg" alt="Generic placeholder image" />
                                                <div class="live-status bg-success"></div>
                                            </a>
                                            <div class="media-body">
                                        ...
                                        <div class="media userlist-box waves-effect waves-light" data-id="3" data-status="online" data-username="Alice">
                                            <a class="media-left" href="#!">
                                                <img class="media-object img-radius" src="<?= base_url('assets') ?>/template_files/avatar-4.jpg" alt="Generic placeholder image" />
                                                <div class="live-status bg-success"></div>
                                            </a>
                                            <div class="media-body">
                                        ...
                                        <div class="media userlist-box waves-effect waves-light" data-id="4" data-status="offline" data-username="Alia">
                                            <a class="media-left" href="#!">
                                                <img class="media-object img-radius" src="<?= base_url('assets') ?>/template_files/avatar-3.jpg" alt="Generic placeholder image" />
                        ...
                        <div class="main-friend-chat" style="overflow: hidden; width: auto; height: 444px;">
                            <div class="media chat-messages">
                                <a class="media-left photo-table" href="#!">
                                    <img class="media-object img-radius img-radius m-t-5" src="<?= base_url('assets') ?>/template_files/avatar-2.jpg" alt="Generic placeholder image" />
                                </a>
                                    ...
                                    <div class="page-wrapper">
                                        <div class="page-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 col-xl-4" id="summary_cards">
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="card proj-progress-card">
                                                        <div class="card-block">
                                                            <div class="row" id="progress_summary"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="card-block">
                                                            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 290px;">
                                                                <div class="scroll-widget" style="overflow: hidden; width: auto; height: 290px;">
                                                                    <div class="latest-update-box" id="whats_new">
                                                ...
                                                <div class="col-xl-4 col-md-6">
                                                    <div class="card latest-update-card">
                                                        ...
                                                        <div class="card-block">
                                                            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 290px;">
                                                                <div class="scroll-widget" style="overflow: hidden; width: auto; height: 290px;">
                                                                    <div class="latest-update-box" id="latest_activity">
                                                    ...
                                                    <div class="card table-card">
                                                        ...
                                                        <div class="card-block p-b-0">
                                                            <div class="table-responsive">
                                                                <table class="table table-hover m-b-0" id="products_table">
                                                                    <thead>
                                                                        <tr>
                                                                            <th>Name</th>
                                                                            <th>Product Code</th>
        ...
        <script type="text/javascript" src="<?= base_url('assets') ?>/template_files/jquery.min.js.download"></script>
        <script type="text/javascript" src="<?= base_url('assets') ?>/template_files/jquery-ui.min.js.download"></script>
        <script type="text/javascript" src="<?= base_url('assets') ?>/template_files/popper.min.js.download"></script>
        <script type="text/javascript" src="<?= base_url('assets') ?>/template_files/bootstrap.min.js.download"></script>

        <script src="<?= base_url('assets') ?>/template_files/waves.min.js.download"></script>

        <script type="text/javascript" src="<?= base_url('assets') ?>/template_files/jquery.slimscroll.js.download"></script>

        <script src="<?= base_url('assets') ?>/template_files/jquery.flot.js.download"></script>
        <script src="<?= base_url('assets') ?>/template_files/jquery.flot.categories.js.download"></script>
        <script src="<?= base_url('assets') ?>/template_files/curvedLines.js.download"></script>
        <script src="<?= base_url('assets') ?>/template_files/jquery.flot.tooltip.min.js.download"></script>

        <script src="<?= base_url('assets') ?>/template_files/chartist.js.download"></script>

        <script src="<?= base_url('assets') ?>/template_files/amcharts.js.download"></script>
        <script src="<?= base_url('assets') ?>/template_files/serial.js.download"></script>
        <script src="<?= base_url('assets') ?>/template_files/light.js.download"></script>

        <script src="<?= base_url('assets') ?>/template_files/pcoded.min.js.download"></script>
        <script src="<?= base_url('assets') ?>/template_files/vertical-layout.min.js.download"></script>
        <script type="text/javascript" src="<?= base_url('assets') ?>/template_files/custom-dashboard.min.js.download"></script>
        <script type="text/javascript" src="<?= base_url('assets') ?>/template_files/script.min.js.download"></script>

 
<script>
        $(document).ready(function() {
            $.getJSON('<?= base_url("assets/jsons/New_Products.json") ?>', function(data) {
                $.each(data.new_products, function(index, product) {
                    var row = '<tr>' +
                        '<td>' + product.name + '</td>' +
                        '<td>' + product.product_code + '</td>' +
                        '<td>' + product.customer + '</td>' +
                        '<td><label class="label label-danger">' + product.status + '</label></td>' +
                        '<td>';

                    for (var i = 1; i <= 5; i++) {
                        if (i <= product.rating) {
                            row += '<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>';
                        } else {
                            row += '<a href="#!"><i class="fa fa-star f-12 text-default"></i></a>';
                        }
                    }
...
<script>
    $(document).ready(function() {
        $.getJSON('<?= base_url("assets/jsons/Project_Progress_Summary.json") ?>', function(data) {
            $.each(data.project_progress_summary, function(index, item) {

                if(item.title==='Published Project'){
                    var color='red';
                } else if(item.title==='Completed Task'){
                    var color='blue';
                } else if(item.title==='Successfull Task'){
                    var color='green';
                }else{
                    var color='yellow';
                }
                ...
                var html = '<div class="col-xl-3 col-md-6">' +
                    '<h6>' + item.title + '</h6>' +
                    '<h5 class="m-b-30 f-w-700">' + item.value + '<span class="text-c-' + color + ' m-l-10">' + item.percentage + '</span></h5>' +
                    '<div class="progress">' +
                    '<div class="progress-bar bg-c-' + color + '" style="width:' + parseFloat(item.percentage) + '%;"></div>' +
                    '</div>' +
                    '</div>';
                $('#progress_summary').append(html);
            });
...
<script>
    $(document).ready(function() {
        $.getJSON('<?= base_url("assets/jsons/Latest_Activity.json") ?>', function(data) {
            $.each(data.latest_activity, function(index, activity) {
                var html = '<div class="row p-t-10 p-b-20">' +
                    '<div class="col-auto text-right update-meta p-r-0">' +
                    '<i class="b-primary update-icon ring"></i>' +
                    '</div>' +
                    '<div class="col p-l-5">' +
                    '<a href="#!"><h6>' + activity.activity_type + '</h6></a>' +
                    '<p class="text-muted m-b-0">' + activity.activity + ' <a href="' + activity.readmore_link + '" class="text-c-blue"> Read More</a></p>' +
                    '</div>' +
                    '</div>';
                $('#latest_activity').append(html);
            });
        }).fail(function(jqxhr, textStatus, error) {
            var err = textStatus + ", " + error;
            console.error("Request failed: " + err);
...
<script>
        $(document).ready(function() {
            $.getJSON('<?= base_url("assets/jsons/Whats_New.json") ?>', function(data) {
                $.each(data.what_new_items, function(index, item) {
                    var html = '<div class="row p-t-20 p-b-30">' +
                        '<div class="col-auto text-right update-meta p-r-0">';
                    
                    // Check if the message contains an image or icon
                    if (item.message.includes('img src')) {
                        html += '<img src="' + item.message.split('img src="')[1].split('"')[0] + '" alt="user image" class="img-radius img-40 align-top m-r-15 update-icon" />';
                    } else if (item.message.includes('feather icon')) {
                        html += '<i class="' + item.message.split('feather icon-')[1].split(' ')[0] + ' bg-c-red update-icon"></i>';
                    } else {
                        html += '<i class="b-primary update-icon ring"></i>';
                    }
...
<script>
        $(document).ready(function() {
            $.getJSON('<?= base_url("assets/jsons/summary.json") ?>', function(data) {
                $.each(data.summary, function(index, item) {
                    var iconClass = '';
                    if (item.title === 'Impressions') {
                        iconClass = 'fas fa-eye bg-c-blue';
                    } else if (item.title === 'Goal') {
                        iconClass = 'fas fa-bullseye bg-c-green';
                    } else if (item.title === 'Impact') {
                        iconClass = 'fas fa-hand-paper bg-c-yellow';
                    }

                    var html = '<div class="card comp-card">' +
                        '<div class="card-body">' +
